...
class LinkUtxo(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, height, input_value, output_value, timestamp, tx_hash, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, height, input_value, output_value, timestamp, tx_hash, *args, **kwargs):  # noqa: E501
        """LinkUtxo - a model defined in OpenAPI
