...
@registry.register_transform(
	display_name='To Known Entities',
	input_entity='maltego.Cryptocurrency',
	description='Returns entities with known attribution tags in outgoing Txs',
	output_entities=['maltego.Cryptocurrency']
)

class ToKnownEntities(DiscoverableTransform):
	"""
