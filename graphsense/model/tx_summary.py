...
class TxSummary(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, height, timestamp, tx_hash, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, height, timestamp, tx_hash, *args, **kwargs):  # noqa: E501
        """TxSummary - a model defined in OpenAPI
