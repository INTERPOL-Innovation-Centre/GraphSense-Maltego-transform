...
class Address(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, address, balance, entity, first_tx, in_degree, last_tx, no_incoming_txs, no_outgoing_txs, out_degree, total_received, total_spent, *args, **kwargs):  # noqa: E501
