...
class Neighbor(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, balance, id, no_txs, node_type, received, value, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, balance, id, no_txs, node_type, received, value, *args, **kwargs):  # noqa: E501
        """Neighbor - a model defined in OpenAPI
